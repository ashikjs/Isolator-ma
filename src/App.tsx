            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
              <div className="text-center">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  >
                    {isPaid ? 'Get Started' : 'Start Free Trial'} <ArrowRight className="ml-2 h-5 w-5"/>
                  </Link>
                </div>
              </div>
              ...
              {!isPaid &&
                  <div id="pricing" className="mt-32">
                      ...
                      <p className="text-xl text-gray-600 text-center mb-16 max-w-2xl mx-auto">
                          Choose the plan that best fits your needs. All plans include access to our core calculation
                          engine.
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {/* Essential Plan */}
                          <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-blue-600 relative">
                              <div
                                  className="absolute top-0 right-8 transform -translate-y-1/2 bg-blue-600 text-white px-4 py-1 rounded-full text-sm">
                                  Popular
                              </div>
